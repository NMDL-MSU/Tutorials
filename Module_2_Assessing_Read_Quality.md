...
### Directory input files
mkdir=$HOME/RNAseq_Pipeline/Quality/Raw/out
Qrep=$HOME/RNAseq_Pipeline/Quality/Raw/out
mv $HOME/RNAseq_Pipeline/Quality/Raw/*.zip $Qrep
...
MultiQC will generate an HTML file with the concatenated FASTQC reports.
